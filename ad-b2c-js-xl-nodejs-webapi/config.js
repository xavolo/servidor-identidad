...
const clientID = "0ea9bdc6-4eb4-4bce-ae90-d072637063f6"; // Application (client) ID of your API's application registration
const b2cDomainHost = "saludsaidentidad01.b2clogin.com";
const tenantId = "saludsaidentidad01.onmicrosoft.com"; // Alternatively, you can use your Directory (tenant) ID (a GUID)
const policyName = "B2C_1_InicioSesion";
